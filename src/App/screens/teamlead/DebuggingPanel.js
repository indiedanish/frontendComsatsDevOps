...
const ListFluidPage = () => {
  ...
  const getAccepted = () => {
    ...
    projectInfo.data.Requirements.map((item) => {
      if (item.Accepted && item.Type == "Debugging") {
        accepted++;
        return item;
      }
    });
                ...
                <Card stretch={true}>
                  <CardHeader borderSize={1}>
                    <CardLabel icon="Box" iconColor="info">
                      <CardTitle className="pl-3"> Debugging Panel</CardTitle>
                    </CardLabel>
                    <CardActions>
                        ...
                        <Card shadow='sm'>
                          <CardHeader>
                            <CardLabel icon='Info' iconColor='success'>
                              <CardTitle>Debugging Work Information</CardTitle>
                            </CardLabel>
                          </CardHeader>
                          <CardBody>
                    ...
                    <div className='row'>
                      <div className='col-md-8'>
                        <Card shadow='sm'>
                          <CardHeader>
                            <CardLabel icon='Info' iconColor='success'>
                              <CardTitle>Debugging Work</CardTitle>
                            </CardLabel>
                          </CardHeader>
                          <CardBody>
                            <div className='row g-4'>
