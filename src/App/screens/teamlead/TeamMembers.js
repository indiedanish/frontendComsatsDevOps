...
import TeamMembersEditModal from "./TeamMembersEditModal";
...
const TeamMembers = () => {
  ...
  const getProject = async (projectname) => {
    ...
    const response = await axios.post(
      "http://localhost:3500/student/getTeamMembers",
      { Name: projectname },
      {
  ...
  const Delete = async (RegNo, ProjectName) => {
    console.log(RegNo, ProjectName)
    await axios.put(`http://localhost:3500/student/deleteTeamMember`, 
    { Student: RegNo, Name: ProjectName },
    {
      withCredentials: true, //correct
    });
                              ...
                              <DropdownMenu isAlignmentEnd>
                                <DropdownItem>
                                  <Button
                                    ...
                                    tag="a"
                                    onClick={() => {
                                      Delete(i.RegNo, projectInfo.Name);
                                      setRefresh(!refresh);
                                    }}
                                  >
                                    Delete
